import"./assets/modulepreload-polyfill-B5Qt9EMX.js";/* empty css                      */import{a as p}from"./assets/vendor-BJ9gahTP.js";const d="https://api.themoviedb.org/3",m="/trending/movie/week",n=document.querySelector(".js-movie-list"),l=document.querySelector(".js-guard"),g={root:null,rootMargin:"1500px",threshold:0},u=new IntersectionObserver(v,g);let s=1;async function a(e=1){return(await p(`${d}${m}`,{params:{api_key:"e4a0965059e007f76bde4a755dff63eb",page:e}})).data}function i(e){return e.map(({original_title:t,vote_average:r,poster_path:o,release_date:c})=>`
<li class="movie-card">
